...
namespace FeaEntidades.Reporte
{
	...
	public partial class linea
	{
		...
		[FileHelpers.FieldIgnored()]
		private lineaDescuentos[] lineaDescuentosField = new lineaDescuentos[50];
		...
		/// <comentarios/>
		[System.Xml.Serialization.XmlElementAttribute("lineaDescuentos")]
		public lineaDescuentos[] lineaDescuentos
		{
			get
			{
				return this.lineaDescuentosField;
			}
			set
			{
				this.lineaDescuentosField = value;
			}
		}
