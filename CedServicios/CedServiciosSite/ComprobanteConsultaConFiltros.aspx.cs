...
{
    public partial class ComprobanteConsultaConFiltros : System.Web.UI.Page
    {
                ...
                else
                {
                    ...
                    switch (ElementoTextBox.Text)
                    {
                        case "Comprobante":
                            ...
                            ComprobantePagingGridView.Columns[Funciones.IndiceColumnaXNombre(ComprobantePagingGridView, "Fecha emi.")].Visible = false;
                            break;
                        case "Contrato":
                            ViewState["NaturalezaComprobante"] = RN.NaturalezaComprobante.Lista(Entidades.Enum.Elemento.Contrato, sesion);
                            NaturalezaComprobanteDropDownList.DataSource = (List<Entidades.NaturalezaComprobante>)ViewState["NaturalezaComprobante"];
                            ComprobantePagingGridView.Columns[Funciones.IndiceColumnaXNombre(ComprobantePagingGridView, "Naturaleza")].Visible = false;
                            ComprobantePagingGridView.Columns[Funciones.IndiceColumnaXNombre(ComprobantePagingGridView, "Fecha")].Visible = false;
                            ComprobantePagingGridView.Columns[Funciones.IndiceColumnaXNombre(ComprobantePagingGridView, "Fecha Vto")].Visible = false;
                            ComprobantePagingGridView.Columns[Funciones.IndiceColumnaXNombre(ComprobantePagingGridView, "Nro.Lote")].Visible = false;
                            ComprobantePagingGridView.Columns[Funciones.IndiceColumnaXNombre(ComprobantePagingGridView, "Acción")].Visible = false;
                    ...
                    switch (TratamientoTextBox.Text)
                    {
                        case "Consulta":
                            ...
                            ComprobantePagingGridView.Columns[0].Visible = true;
                            break;
                        case "Baja/Anul.baja":
                            ...
                            ComprobantePagingGridView.Columns[1].Visible = true;
                            ComprobantePagingGridView.Columns[2].Visible = true;
                            ComprobantePagingGridView.Columns[Funciones.IndiceColumnaXNombre(ComprobantePagingGridView, "Acción")].Visible = false;
                            break;
                        case "Envio":
                            ViewState["Estados"] = RN.Estado.ListaComprobantesSoloPteEnvio();
                            EstadoGridView.DataSource = ViewState["Estados"];
                            ComprobantePagingGridView.Columns[3].Visible = true;
                            ComprobantePagingGridView.Columns[Funciones.IndiceColumnaXNombre(ComprobantePagingGridView, "Acción")].Visible = false;
                        ...
                        case "Modificacion":
                            ...
                            ComprobantePagingGridView.Columns[4].Visible = true;
                            ComprobantePagingGridView.Columns[Funciones.IndiceColumnaXNombre(ComprobantePagingGridView, "Acción")].Visible = false;
        ...
        protected void ComprobantePagingGridView_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                DesSeleccionarFilas();
                Entidades.Sesion sesion = ((Entidades.Sesion)Session["Sesion"]);
                ComprobantePagingGridView.PageIndex = e.NewPageIndex;
                ViewState["GridPageIndex"] = e.NewPageIndex;
                List<Entidades.Comprobante> lista;
                int CantidadFilas = 0;
                ...
                ComprobantePagingGridView.DataSource = lista;
        ...
        protected void ComprobantePagingGridView_Sorting(object sender, GridViewSortEventArgs e)
        {
            try
            {
                DesSeleccionarFilas();
        ...
        {
            ComprobantePagingGridView.SelectedIndex = -1;
        }

        protected void ComprobantePagingGridView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            MensajeLabel.Text = "";
            ...
            try
            {
                ...
                List<Entidades.Comprobante> lista = (List<Entidades.Comprobante>)ViewState["lista"];
                comprobante = (Entidades.Comprobante)lista[item].Clone();
                RN.Comprobante.Leer(comprobante, sesion);
            }
            catch
            {
                //No hago nada con el CommandArgument.
            }
            ...
            bindGrillaComprobante();
        }

        protected void ComprobantePagingGridView_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ComprobantePagingGridView.EditIndex = e.NewEditIndex;
            ComprobantePagingGridView.DataSource = ViewState["lista"];
            ComprobantePagingGridView.DataBind();
        }
        protected void ComprobantePagingGridView_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
        {
            ComprobantePagingGridView.EditIndex = -1;
            ComprobantePagingGridView.DataSource = ViewState["lista"];
            ComprobantePagingGridView.DataBind();
        }
        protected void ComprobantePagingGridView_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ComprobantePagingGridView.EditIndex = -1;
        ...
        protected void ComprobantePagingGridView_SelectedIndexChanged(object sender, EventArgs e)
        {
        }

        protected void ComprobantePagingGridView_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
        }
        ...
        protected void ComprobantePagingGridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void BuscarButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (ElementoTextBox.Text == "Contrato" || ValidacionFiltrosOK())
                {
                    ...
                    if (lista.Count == 0)
                    {
                        ComprobantePagingGridView.DataSource = null;
                        ComprobantePagingGridView.DataBind();
        ...
        private void bindGrillaComprobante()
        {
            ComprobantePagingGridView.PageIndex = Convert.ToInt32(ViewState["GridPageIndex"]);
            ComprobantePagingGridView.DataSource = ViewState["lista"];
            ComprobantePagingGridView.DataBind();
        }
