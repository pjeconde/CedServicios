...
namespace CedServicios.Site.org.dyndns.cedweb.generoPDF {
    ...
    public partial class GeneroPDF : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void GenerarPDFAsync(string CuitVendedor, int NroPuntoVta, int TipoComprobante, long NroComprobante, string ArchivoXML) {
            this.GenerarPDFAsync(CuitVendedor, NroPuntoVta, TipoComprobante, NroComprobante, ArchivoXML, null);
        }
        
        /// <remarks/>
        public void GenerarPDFAsync(string CuitVendedor, int NroPuntoVta, int TipoComprobante, long NroComprobante, string ArchivoXML, object userState) {
