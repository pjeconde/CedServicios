            ...
            <div class="row">
                <div class="main_features_content2">
                    <div class="head_title text-center">
                        <h2><asp:Label ID="TituloPaginaLabel" runat="server" SkinID="TituloPagina" Text="Explorador de Autorizaciones Pendientes"></asp:Label>
                        </h2>
                ...
                <div class="col-lg-12 col-md-12 text-center padding-top-20">
                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                        <asp:GridView ID="AutorizacionesGridView" runat="server" HorizontalAlign="Center" 
