<%@ Page Title="" Language="C#" MasterPageFile="~/CedServicios.Master" AutoEventWireup="true" CodeBehind="IvaComprasFiltros.aspx.cs" Inherits="CedServicios.Site.Facturacion.Electronica.Reportes.IvaComprasFiltros" Theme="CedServicios" %>
            ...
            <table align="center">
                <tr>
                    <td colspan="3" style="padding-top:20px; padding-bottom:20px; text-align:center">
                        <asp:Label ID="TituloPaginaLabel" runat="server" SkinID="TituloPagina" Text="IVA Compras"></asp:Label>
