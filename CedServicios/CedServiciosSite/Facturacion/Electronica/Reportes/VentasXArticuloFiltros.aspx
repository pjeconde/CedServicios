<%@ Page Title="" Language="C#" MasterPageFile="~/CedServicios.Master" AutoEventWireup="true" CodeBehind="VentasXArticuloFiltros.aspx.cs" Inherits="CedServicios.Site.Facturacion.Electronica.Reportes.VentasXArticuloFiltros" Theme="CedServicios" %>
