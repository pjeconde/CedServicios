...
<table style="width: 1282px">
	...
	<tr>
		<td style="text-align: center; padding: 3px; font-weight: normal;">
            <asp:UpdatePanel ID="referenciasUpdatePanel" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
				<ContentTemplate>
					<asp:GridView ID="referenciasGridView" runat="server" 
						...
						<Columns>
                            <asp:TemplateField HeaderText="Tipo de comprobante AFIP">
                                ...
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddltipo_comprobante_afipEdit" runat="server" Width="80px">
                                    </asp:DropDownList>
                                </EditItemTemplate>
                                <FooterTemplate>
	...
	<tr>
		<td style="text-align: center; height: 10px;">
			<asp:UpdateProgress ID="referenciasUpdateProgress" runat="server" AssociatedUpdatePanelID="referenciasUpdatePanel" DisplayAfter="0">
				<ProgressTemplate>
