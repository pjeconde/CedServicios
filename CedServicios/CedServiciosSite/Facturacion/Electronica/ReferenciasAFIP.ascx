...
<table style="width: 1282px">
	...
	<tr>
        ...
        <a href="javascript:void(0)" id="A2" role="button" class="popover-test" data-html="true" title="Código de operación" style="width: 200px"
                                                        data-content="Usted podrá ingresar Referencias con un tipo de compronte AFIP, solo si el tipo de comprobante que usted esta realizando es igual a 2-NDA, 3-NCA, 7-NDB, 8-NCB, 12-NDC, 13-NCC, 52 o 53.">
