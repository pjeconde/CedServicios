                    ...
                    <table style="padding-left:10px" align="center">
                        ...
                        <tr>
			                ...
			                <td align="left" style="padding-top:5px">
				                <asp:DropDownList ID="TipoDocDropDownList" runat="server" TabIndex="2" CssClass=""  
                                ...
                                &nbsp;<a href="#" role="button" class="popover-test" data-html="true" title="OBTENER DATOS FISCALES" data-content="Permite obtener datos del Padrón de la AFIP, a partir del ingreso del CUIT.</br></br>Los datos que intentará completar son los siguientes:</br><span style='padding-right:5px'><i class='fa fa-check-square'></i></span>Razón Social</br><span style='padding-right:5px'><i class='fa fa-check-square'></i></span>Dirección completa</br><span style='padding-right:5px'><i class='fa fa-check-square'></i></span>Localidad</br><span style='padding-right:5px'><i class='fa fa-check-square'></i></span>Provincia</br><span style='padding-right:5px'><i class='fa fa-check-square'></i></span>Código Postal</br><span style='padding-right:5px'><i class='fa fa-check-square'></i></span>Inicio de Actividades"><span class="glyphicon glyphicon-info-sign gi-1x" style="vertical-align: inherit"></span></a>
			                </td>
                        </tr>
                        <tr>
                            <td align="right" style="padding-right:5px; padding-top:5px">
                        ...
                        <tr>
                            ...
                            <td align="left" style="padding-top:2px">
                                <asp:TextBox ID="RazonSocialTextBox" runat="server" MaxLength="50" TabIndex="5" Width="400px"></asp:TextBox>
                            </td>        
                        </tr>
