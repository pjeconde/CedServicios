    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                ...
                <p class="text-left">
                    <asp:Label ID="Label2" runat="server" Text="Nuestra empresa fue fundada en el año 1980 por un grupo de profesionales con el objetivo de cubrir las necesidades informáticas que el mercado requería en ese momento. Hoy en día, con más de 25 años de experiencia, estamos en condiciones de brindarle a Ud. una solución integrada para la gestión, control y desarrollo de negocios.<br /><br />
                        Contamos no solo con personal altamente capacitado, sino con el know how necesario adquirido a través de cientos de implantaciones en las diversas áreas empresariales. Esta conjunción de elementos nos permite satisfacer a nuestros clientes en tiempo y forma, permitiendo que obtengan la mejor tasa de retorno de la inversión.">
                    </asp:Label>
                </p>
                </div>
                <div class="col-lg-3 col-md-3">
            ...
            <p>
                <b><asp:Label ID="Label10" runat="server" Text="Soluciones llave en mano: "></asp:Label></b>
            ...
            <p>
                ...
                <asp:Button ID="SalirButton" runat="server" CssClass="btn btn-primary" CausesValidation="false" TabIndex="4" Text="Salir" onclick="SalirButton_Click" />        
            </p>
            <p>
