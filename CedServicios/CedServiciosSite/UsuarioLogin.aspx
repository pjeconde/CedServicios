...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceDefault" runat="server">
    <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="right" class="TextoInicioMediano" style="padding-left: 10px; padding-right: 10px; padding-top: 10px">
                Contraseña
            </td>
            <td align="left" style="width: 100px; padding-right: 10px; padding-top: 10px">
