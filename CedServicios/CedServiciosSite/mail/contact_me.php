...
$recipients = "contacto@cedeira.com"; # $_POST["para"]; # "contacto@cedeira.com"; # Mail del receptor del correo
$headers["From"] = "contacto@cedeira.com"; # Cuenta de correo valida del dominio
$headers["To"] = "contacto@cedeira.com"; # $_POST["para"]; # "contacto@cedeira.com"; # Destinatario del correo
