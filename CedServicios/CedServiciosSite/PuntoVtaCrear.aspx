...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceDefault" runat="server">
    ...
    <table align="center">
        ...
        <tr>
			...
			<td align="left" style="padding-top:5px">
				<asp:DropDownList ID="IdMetodoGeneracionNumeracionLoteDropDownList" runat="server" TabIndex="5" Width="650px" DataValueField="Id" DataTextField="Descr">
				</asp:DropDownList>
			</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" style="height: 24px; padding-top:20px">
                ...
                <asp:Button ID="SalirButton" runat="server" CausesValidation="false" TabIndex="502" Text="Cancelar" onclick="SalirButton_Click" />
            </td>
        </tr>
        <tr>
            <td align="center" colspan="2" style="padding-top:20px">
