(function($) { "use strict";
	...
	$(document).ready(function() {
	  ...
	  var sync1 = $("#sync-sortcodes-5");
	  var sync2 = $("#sync-sortcodes-6");
	  ...
	  function syncPosition(el){
		...
		$("#sync-sortcodes-6")
		  ...
		  .eq(current)
		  .addClass("synced")
		if($("#sync-sortcodes-6").data("owlCarousel") !== undefined){
		  center(current)
		}
	  }
	 
	  $("#sync-sortcodes-6").on("click", ".owl-item", function(e){
		e.preventDefault();
		var number = $(this).data("owlItem");
		sync1.trigger("owl.goTo",number);
	  });
	...
	$(document).ready(function() {
	  ...
	  var sync1 = $("#sync-sortcodes-7");
	  var sync2 = $("#sync-sortcodes-8");
	  ...
	  function syncPosition(el){
		...
		$("#sync-sortcodes-8")
		  ...
		  .eq(current)
		  .addClass("synced")
		if($("#sync-sortcodes-8").data("owlCarousel") !== undefined){
		  center(current)
		}
	  }
	 
	  $("#sync-sortcodes-8").on("click", ".owl-item", function(e){
		e.preventDefault();
		var number = $(this).data("owlItem");
		sync1.trigger("owl.goTo",number);
	  });
