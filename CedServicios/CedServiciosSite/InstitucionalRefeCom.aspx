...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceDefault" runat="server">
    <table border="0" cellpadding="0" cellspacing="0" style="padding-left:10px">
        ...
        <tr>
            <td align="left">
                <b>Agro</b><br />
                K+S Argentina S.R.L. • ADM ARGENTINA S.A.
        ...
        <tr>
            <td align="center" style="height: 24px; padding-top: 20px">
                <asp:Button ID="EmpresaButton" runat="server" TabIndex="1" Text="Empresa" onclick="EmpresaButton_Click" 
                     />
                <asp:Button ID="SolucionesButton" runat="server" CausesValidation="false" 
                    TabIndex="2" Text="Soluciones" onclick="SolucionesButton_Click"  />
                <asp:Button ID="ContactoButton" runat="server" CausesValidation="false" 
                    TabIndex="3" Text="Contacto" onclick="ContactoButton_Click"  />
            </td>
        </tr>
        <tr>
