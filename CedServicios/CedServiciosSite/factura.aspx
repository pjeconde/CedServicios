<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="factura.aspx.cs" Inherits="CedServicios.Site.factura" %>
	...
	<div class="header-top">
		...
		<ul class="cd-nav-gallery is-hidden">						
						...
						<li>
							<div class="services-boxes-1">
						<div class="icon-box">&#xf0ed;</div>
						<h6><a href="factura.html">FACTURA ELECTRONICA</a></h6>						
					</div>
						</li>						
					</ul>			
...
<ul class="cd-nav-gallery is-hidden">
						...
						<li>
							<a class="cd-nav-item animsition-link" href="transferencias.html">
								...
								<h3>Sistema de Transferencias
"implementación BCRA"</h3>
							</a>
						</li>
    ...
    <section class="section footer-1 section-padding-top-bottom" style="background: #3bb2df">
        <div class="container" style="text-align: center">
            ...
            <form name="ajax-form" id="ajax-form" method="get">
                ...
                <div class="sixteen columns">
                    <p style="text-align: center"><a href="#">Crear una nueva cuenta </a>- <a href="#">¿Olvidó su Id.Usuario?</a> - <a href="#">¿Olvidó su Contraseña?</a></p>
                </div>
                <div class="clear"></div>
            </form>
...
<li>Notas de crédito y notas de débito clase “T”.</li></ul>
<h6>Comprobantes excluídos</h6>
Quedan excluidos del presente régimen:
<ul>
<li>Los comprobantes emitidos por aquellos sujetos que realicen operaciones que requieren un tratamiento especial en la emisión de comprobantes, según lo dispuesto en el Anexo IV de la RG 1415/03, (agentes de bolsa y de mercado abierto, concesionarios del sistema nacional de aeropuertos, servicios prestados por el uso de aeroestaciones correspondientes a vuelos de cabotaje e internacionales, distribuidores de diarios, revistas y afines, etc.).
<li>Las facturas o documentos equivalentes emitidos por los sujetos indicados en el Apartado A del Anexo I de la RG 1415/03, respecto de las operaciones allí detalladas, en tanto no se encuentren en las situaciones previstas en el Apartado B del mismo Anexo I.
<li>Los comprobantes y documentos fiscales emitidos mediante “Controlador Fiscal”, y las notas de crédito emitidas por medio de dicho equipamiento como documentos no fiscales homologados y/o autorizados.
<li>Los documentos equivalentes emitidos por entidades o sujetos especialmente autorizados por esta Administración Federal y/o la “Liquidación Primaria de Granos”.
</ul>
<h6>Aclaración</h6>
...
<ul>
<li>Sujetos Monotributistas: Quienes se encuentren inscriptos en las categorías H, I, J, K y L. Aquellos sujetos que sean Monotributistas por los comprobantes emitidos al Sector Público Nacional – que requieran Certificado Fiscal para Contratar con el Estado-.
		...
		<section class="section footer-1 section-padding-top-bottom" id="scroll-link-5">	
			<div class="container">
				...
				<a href="index.html" class="animsition-link"><div class="logo-footer"></div></a>
					<h6><A HREF="https://www.google.com/maps/dir//Esmeralda+950,+C1007ABL+CABA" target="_blank" style="color: #fff"><i class="icon-footer">&#xf041;</i>Argentina</a></h6>
					<p style="color: #fff"><A HREF="https://www.google.com/maps/dir//Esmeralda+950,+C1007ABL+CABA" target="_blank" style="color: #fff">Torre Bellini, Esmeralda 950, Piso 19, Of. 105, CABA</a><br/>
					+5411 4778-1744</p>
...
<section class="section darkgrey-section section-padding-top-bottom" id="fatfooter">	
			<div class="container">
				...
				<div class="four columns" data-scroll-reveal="enter left move 200px over 0.5s after 0.3s" data-scroll-reveal-id="2" data-scroll-reveal-initialized="true" data-scroll-reveal-complete="true">
					<h6>SERVICIOS</h6>
					<ul class="circle"><li><a href="desarrollos.html" class="animsition-link">DESARROLLOS A MEDIDA</a></li><li><a href="sf.html" class="animsition-link">SOFTWARE FACTORY</a></li><li><a href="factura.html" class="animsition-link">FACTURA ELECTRONICA</a></li></ul>
				...
				<div class="four columns" data-scroll-reveal="enter right move 200px over 0.5s after 0.3s" data-scroll-reveal-id="3" data-scroll-reveal-initialized="true" data-scroll-reveal-complete="true">
					<h6>PRODUCTOS</h6>
					<ul class="circle"><li><a href="transferencias.html" class="animsition-link">Sistema de Transferencias
"implementación BCRA"</a></li>
...
<li><a href="stock.html" class="animsition-link">Gestión de Stock de Servicios y Tarjetas	</a></li>	</ul>			
...
<%--					<form name="ajax-form" id="" action="" method="post">
					...
					<div class="sixteen columns">
						<div id=""><button class="send_message" id="">SUSCRIBIRSE</button></div>
					</div>
					<div class="clear"></div>						
