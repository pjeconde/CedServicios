...
<tr>
	...
	<td style="padding-top:5px">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left">
					<asp:TextBox ID="CalleTextBox" runat="server" MaxLength="30" TabIndex="101" Width="150px"></asp:TextBox>
				</td>
				...
				<td align="left" style="padding-left: 5px;">
					<asp:TextBox ID="NroTextBox" runat="server" MaxLength="6" TabIndex="102" Width="40px"></asp:TextBox>
				</td>
				<td align="right" style="padding-left: 5px">
				...
				<td align="left" style="padding-left: 5px">
					<asp:TextBox ID="PisoTextBox" runat="server" MaxLength="5" TabIndex="103" Width="25px"></asp:TextBox>
				</td>
				<td align="right" style="padding-left: 5px">
				...
				<td align="left" style="padding-left: 5px">
					<asp:TextBox ID="DeptoTextBox" runat="server" MaxLength="5" TabIndex="104" Width="25px"></asp:TextBox>
				</td>
			</tr>
		</table>
	</td>
...
<tr>
	...
	<td align="left" style="padding-top:5px">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td>
					<asp:TextBox ID="SectorTextBox" runat="server" MaxLength="5" TabIndex="105" Width="120px"></asp:TextBox>
				</td>
				...
				<td style="padding-left: 5px">
					<asp:TextBox ID="TorreTextBox" runat="server" MaxLength="5" TabIndex="106" Width="55px"></asp:TextBox>
				</td>
				...
				<td style="padding-left: 5px">
					<asp:TextBox ID="ManzanaTextBox" runat="server" MaxLength="5" TabIndex="107" Width="67px"></asp:TextBox>
				</td>
			</tr>
		</table>
	</td>
