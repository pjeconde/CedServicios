<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DatosEmailAvisoComprobanteContratoConsulta.ascx.cs" Inherits="CedServicios.Site.Controles.DatosEmailAvisoComprobanteContratoConsulta" %>
