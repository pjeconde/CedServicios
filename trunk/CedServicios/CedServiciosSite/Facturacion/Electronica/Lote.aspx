<%@ Page AutoEventWireup="true" Theme="CedServicios" Buffer="true" Codebehind="Lote.aspx.cs" Culture="en-GB"
	Inherits="CedServicios.Site.Facturacion.Electronica.Lote" Language="C#" MaintainScrollPositionOnPostback="true"
	MasterPageFile="~/CedServicios.Master" Title="Factura Electrónica Gratis(Interfacturas - AFIP)"
																	...
																	<tr>
																		...
																		<td style="padding-top: 3px;">
                                                                            ...
                                                                            <cc1:CalendarExtender ID="CalendarExtender1" runat="server"  CssClass="MyCalendar" OnClientShown="onCalendar1Shown"
                                                                                TargetControlID="FechaEmisionDatePickerWebUserControl" Format="yyyyMMdd" PopupButtonID="ImageCalendarFechaEmision" >
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" >
																	<tr>
																		...
																		<td align="left" style="padding-top: 3px;" valign="top">
																			<asp:TextBox ID="InicioDeActividadesVendedorDatePickerWebUserControl" runat="server"></asp:TextBox>
                                                                            <cc1:CalendarExtender ID="CalendarExtender2" runat="server" CssClass="MyCalendar"  OnClientShown="onCalendar1Shown"
                                                                                    TargetControlID="InicioDeActividadesVendedorDatePickerWebUserControl" Format="yyyyMMdd" PopupButtonID="ImageCalendarInicioDeActividadesVendedor">
                                                                            </cc1:CalendarExtender>
																		</td>
																		<td align="left" style="width: 34px">
														...
														<td align="left" valign="top">
															<table border="0" cellpadding="0" cellspacing="0" style="width: 370px">
																...
																<tr>
																	...
																	<td style="padding-top: 3px;">
																		<asp:TextBox ID="InicioDeActividadesCompradorDatePickerWebUserControl" runat="server"></asp:TextBox>
                                                                        <cc1:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="InicioDeActividadesCompradorDatePickerWebUserControl" Format="yyyyMMdd" CssClass="MyCalendar" PopupButtonID="ImageCalendarInicioDeActividadesComprador">
                                                                        </cc1:CalendarExtender>
														...
														<td align="left" valign="top">
															<table border="0" cellpadding="0" cellspacing="0" style="width: 370px">
																<tr>
																	...
																	<td style="padding-top: 3px;">
                                                                        <asp:TextBox ID="FechaVencimientoDatePickerWebUserControl" runat="server"></asp:TextBox>
																        <cc1:CalendarExtender ID="CalendarExtender4" runat="server" 
                                                                            TargetControlID="FechaVencimientoDatePickerWebUserControl" Format="yyyyMMdd" CssClass="MyCalendar" PopupButtonID="ImageCalendarFechaVencimiento">
                                                                        </cc1:CalendarExtender>	
														...
														<td align="left" valign="top">
															<table border="0" cellpadding="0" cellspacing="0" style="width: 370px">
																<tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="FechaServDesdeDatePickerWebUserControl" runat="server"></asp:TextBox>
                                                                        <cc1:CalendarExtender ID="CalendarExtender5" runat="server" 
                                                                            TargetControlID="FechaServDesdeDatePickerWebUserControl" Format="yyyyMMdd" CssClass="MyCalendar" PopupButtonID="ImageCalendarFechaServDesde">
                                                                        </cc1:CalendarExtender>	
																...
																<tr>
																	...
																	<td style="padding-top: 3px;">
                                                                        <asp:TextBox ID="FechaServHastaDatePickerWebUserControl" runat="server"></asp:TextBox>
                                                                        <cc1:CalendarExtender ID="CalendarExtender6" runat="server" 
                                                                            TargetControlID="FechaServHastaDatePickerWebUserControl" Format="yyyyMMdd" CssClass="MyCalendar" PopupButtonID="ImageCalendarFechaServHasta">
                                                                        </cc1:CalendarExtender>	
														...
														<tr>
															<td class="TextoLabelFEAVendedorCh" style="padding: 5px; text-align: left; width: 180px">
													            ...
													            <cc1:CalendarExtender ID="CalendarExtender7" runat="server" 
                                                                    TargetControlID="FechaCAEVencimientoDatePickerWebUserControl" Format="yyyyMMdd" CssClass="MyCalendar" PopupButtonID="ImageCalendarFechaCAEVencimiento">
                                                                </cc1:CalendarExtender>
														...
														<tr>
															<td class="TextoLabelFEAVendedorCh" style="padding: 5px; text-align: left; width: 180px">
                                                                ...
                                                                <cc1:CalendarExtender ID="CalendarExtender8" runat="server" 
                                                                    TargetControlID="FechaCAEObtencionDatePickerWebUserControl" Format="yyyyMMdd" CssClass="MyCalendar" PopupButtonID="ImageCalendarFechaCAEObtencion">
                                                                </cc1:CalendarExtender>	
